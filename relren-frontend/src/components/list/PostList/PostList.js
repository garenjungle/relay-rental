...
const PostItem = ({url,title,content,category, city, town, price, unit, min}) => {
  return (
    <div className={cx('post-item')}>
      ...
      <div className={cx('right')}>
        ...
        <div className={cx('address')}><strong>{city}</strong> {town}</div>
        <div className={cx('specific')}>
          <div>
            <div className={cx('price')}>{price}$<strong>/{unit}</strong></div>
            {/* <p>{content}</p> */}
          </div>
          <div>
            <div className={cx('term')}><strong>Min</strong> {min}</div>
...
const PostList = ({ posts }) => {
  posts = new List([
    {url:'https://m.media-amazon.com/images/I/917LEZ+it3L._AC_SX200_SY200_.jpg',
      ...
      category: "Camera",
      city:"Suwon", town:"Youngtong", price:"100", min:"3 Month", unit:"Month"
    },
    {url:'https://images-na.ssl-images-amazon.com/images/I/41Cv21vkL9L._AC_SY200_.jpg',
      ...
      category: "Headphone",
      city:"Souel", town:"Insadong", price:"85", min:"10 Day", unit:"Day"
    },
    {url:'https://images-na.ssl-images-amazon.com/images/I/51I%2BteGzpCL._AC_SY200_.jpg',
      ...
      category: "Joystick",
      city:"Goyang", town:"Insan", price:"30", min:"5 Month", unit:"Month"
    },
    {url:'https://images-na.ssl-images-amazon.com/images/I/41Cq%2BW%2BIooL._AC_SY200_.jpg',
      ...
      category: "Laptop",
      city:"Suwon", town:"Youngtong", price:"200", min:"2 Month", unit:"Month"
    },
   ]);
